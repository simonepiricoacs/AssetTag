...
import it.water.assettag.service.AssetTagApplication;

@SpringBootTest(classes = AssetTagApplication.class,
...
public class AssetTagRestSpringApiTest {
    ...
    Karate restInterfaceTest() {
        return Karate.run("../AssetTag-service/src/test/resources/karate")
